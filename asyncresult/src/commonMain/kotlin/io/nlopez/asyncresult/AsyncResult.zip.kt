...
/**
 * Combines two [AsyncResult]s ([result1] and [result2]) into a single one, by applying the
...
inline fun <R1, R2, reified T> zip(
  ...
  return result1().andThen { value1 ->
    result2().mapSuccess { value2 -> transform(value1, value2) }
  }
}

/**
 * Combines three [AsyncResult]s ([result1], [result2], and [result3]) into a single one, by
...
inline fun <R1, R2, R3, reified T> zip(
  ...
  return result1().andThen { value1 ->
    result2().andThen { value2 ->
      result3().mapSuccess { value3 -> transform(value1, value2, value3) }
    }
  }
}
  ...
  return result1().andThen { value1 ->
    result2().andThen { value2 ->
      result3().andThen { value3 ->
        result4().mapSuccess { value4 -> transform(value1, value2, value3, value4) }
      }
    }
  }
}
...
/**
 * Combines two [AsyncResult]s (the receiver lambda result and the [producer] lambda) into a single
...
inline fun <R1, R2, reified T> (() -> AsyncResult<R1>).zipWith(
  ...
  return invoke().andThen { value1 ->
    producer().mapSuccess { value2 -> transform(value1, value2) }
  }
}

/**
 * Combines three [AsyncResult]s (the receiver lambda result, [producer1], and [producer2]) into a
...
inline fun <R1, R2, R3, reified T> (() -> AsyncResult<R1>).zipWith(
  ...
  return invoke().andThen { value1 ->
    producer1().andThen { value2 ->
      producer2().mapSuccess { value3 -> transform(value1, value2, value3) }
    }
  }
}

/**
 * Combines four [AsyncResult]s (the receiver lambda result, [producer1], [producer2], and
  ...
  return invoke().andThen { value1 ->
    producer1().andThen { value2 ->
      producer2().andThen { value3 ->
        producer3().mapSuccess { value4 -> transform(value1, value2, value3, value4) }
      }
    }
  }
}
...
/**
 * Combines two [AsyncResult]s (the receiver and [result]) into a single one, by applying the
 * [transform] to their values.
 */
@Suppress("LEAKED_IN_PLACE_LAMBDA")
inline fun <R1, R2, reified T> AsyncResult<R1>.zipWith(
  ...
  return andThen { value1 -> result.mapSuccess { value2 -> transform(value1, value2) } }
}

/**
 * Combines three [AsyncResult]s (the receiver, [result1], and [result2]) into a single one, by
 * applying the [transform] to their values.
 */
@Suppress("LEAKED_IN_PLACE_LAMBDA")
inline fun <R1, R2, R3, reified T> AsyncResult<R1>.zipWith(
  ...
  return andThen { value1 ->
    result1.andThen { value2 -> result2.mapSuccess { value3 -> transform(value1, value2, value3) } }
  }
}

/**
 * Combines four [AsyncResult]s (the receiver, [result1], [result2], and [result3]) into a single
 * one, by applying the [transform] to their values.
 */
@Suppress("LEAKED_IN_PLACE_LAMBDA")
inline fun <R1, R2, R3, R4, reified T> AsyncResult<R1>.zipWith(
  ...
  return andThen { value1 ->
    result1.andThen { value2 ->
      result2.andThen { value3 ->
        result3.mapSuccess { value4 -> transform(value1, value2, value3, value4) }
      }
    }
  }
}
