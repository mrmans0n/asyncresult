...
/**
 * Converts a [Success] to an [Error] if the [predicate] returns true for the success value.
 * Other states ([Loading], [NotStarted], [Error]) are returned unchanged.
 *
 * @param predicate Function that receives the success value and returns true if it should become an error.
 * @param error Optional function to create a custom [Error] from the success value. Defaults to [Error.Empty].
...
/**
 * Converts a [Success] to an [Error] if the [predicate] returns false for the success value.
