 ...
 */
fun <R> Flow<AsyncResult<R>>.onLoading(action: suspend () -> Unit): Flow<AsyncResult<R>> = onEach {
 ...
 */
fun <R> Flow<AsyncResult<R>>.onSuccess(action: suspend (R) -> Unit): Flow<AsyncResult<R>> = onEach {
 ...
 */
suspend inline fun <R> Flow<AsyncResult<R>>.getOrThrow(): R =
 ...
 */
suspend inline fun <R> Flow<AsyncResult<R>>.getOrNull(): R? =
